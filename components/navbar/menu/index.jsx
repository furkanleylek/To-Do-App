        ...
        <div className='flex flex-col items-center justify-center w-full h-full'>
            <div className='flex flex-col justify-center w-full h-full '>
                <div className='flex flex-col w-full h-full justify-between gap-4  items-center py-12 px-2 bg-navBlue '>
                    ...
                    <h3 className='text-white text-3xl border-b-2 border-lightGrey text-center pb-2 w-3/5 font-mono italic'>To Do</h3>
                    <div className='flex flex-col items-center  w-full h-[80%] gap-8'>
                        ...
                        <Link className={` flex gap-5 items-center justify-start test-xl font-bold text-white hover:bg-white hover:text-navBlue hover:transition-all w-full p-2 rounded `} href="/profile" onClick={() => setIsOpen(() => false)}>
