...
function LoginModal({ login, setLogin, }) {
    ...
    ">
            <OutsideClickHandler onOutsideClick={() => setLogin(false)} display="contents">
                <div className='shadow-modal w-full exsm:w-[70%] sm:w-[50%] lg:w-[40%] max-w-[450px] animate-modal overflow-y-hidden rounded h-full sm:max-h-[600px] bg-[#F1F1E8]  opacity-10 relative z-50'>
                    {login && (
