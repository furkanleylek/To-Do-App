    ...
    return (
        <div className='flex flex-col w-48 lg:w-60 h-full justify-between items-center py-12 px-2 bg-navBlue'>
            ...
            <div className='flex flex-col items-center justify-center w-full mb-60 gap-8'>
                ...
                <Link className={`${activePage == 2 ? `text-navBlue bg-white` : `text-white `} flex gap-5 items-center justify-start test-xl font-bold hover:bg-white hover:text-navBlue hover:transition-all w-full p-2 rounded `} onClick={() => setActivePage(2)} href="/addjob" >
